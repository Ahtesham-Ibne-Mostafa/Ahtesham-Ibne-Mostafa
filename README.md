<div align="center">
  <img src="https://media.tenor.com/mhLPO2VldCkAAAAC/0001.gif" width="100px" height="100px" alt="Profile GIF">
  <h1>Hey, I'm Ahtesham Ibne Mostafa</h1>
  <h3>Computer Science Undergraduate | AI/ML Researcher | Signal & NLP Enthusiast | Full-Stack Developer</h3>
</div>
...
- **B.Sc. in Computer Science and Engineering**  
  *Brac University, Dhaka — CGPA: 3.06 (as of 2025)*  
  *2021 – Ongoing*
- **Higher Secondary Certificate (HSC)**  
  *Rajendrapur Cantonment Public College, Dhaka Board — GPA: 5.00*  
  *Year: 2020*
- **Secondary School Certificate (SSC)**  
  *Rani Bilashmoni Government Boys High School — GPA: 5.00*  
  *Year: 2018*
...
- **Multimodal Signal and NLP-based Healthcare Analysis (Ongoing Thesis)**
  - ECG Signal Abnormality Detection: Built deep learning models using MIMIC-IV ECG datasets
  - EEG Signal Analysis with IUT: Preprocessed EEG signals using AcqKnowledge, applied ML for cognitive analysis
  - EHR Summarization with NLP: Built a custom NLP pipeline with SpaCy for clinical note summarization
  - Clinical Note Classification: Trained TF-IDF + Logistic Regression models for diagnosis classification
  - Image Processing with Neural Networks: Combined OpenCV filters with deep learning for medical image segmentation

---

## 🛠 Projects

- **3D Survival & Shooting Game**  
  *Python, PyOpenGL, GLUT — Real-time mechanics, collision detection, dynamic 3D environment*
- **Catch the Diamonds – PyOpenGL Game**  
  *Python, PyOpenGL, GLUT — GUI, animation, score-tracking, event-driven programming*
...
- **University Management System**  
  *PHP, MySQL — Student data, attendance, academic operations*
- **BRAC University Empty Room Finder (Ongoing)**  
...
**AI & Data Science:**  
Machine Learning, Deep Learning, NLP, Signal Processing, Computer Vision

**Languages & Libraries:**  
Python, JavaScript, PHP, SQL, PyTorch, TensorFlow, Keras, Scikit-learn, NumPy, Pandas, Matplotlib, OpenCV, SpaCy

**Frameworks:**  
React.js, Node.js, Express.js, Flask, Bootstrap

**Tools:**  
VS Code, PyCharm, Google Colab, Anaconda, Code::Blocks, OracleSQL, Git, Jupyter

**Operating Systems:**  
Windows, macOS, Linux Mint, Fedora, Manjaro

**Full-Stack Development:**  
MERN Stack, PHP/MySQL, REST APIs, JWT Authentication
...
<p align="center">
  ...
  <a href="mailto:ahteshamibnemostafa@gmail.com">
  ...
  <a href="https://twitter.com/MostafaIbne" target="_blank">
...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Linux-fff?style=for-the-badge&logo=linux&color=434343" />
</p>
